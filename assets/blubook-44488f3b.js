import{d as G,x as h,s as S,Z as P,aH as X,y as Y,o as k,b as N,a as m,u as n,a0 as d,f as c,G as x,H as B,w as V,F as w,t as A,S as F,T as K,K as Z,aI as j,M as q,p as J,i as Q,O as M,C as T,D as E,aD as W}from"./vendor-2418a256.js";import{_ as nn}from"./index-60cbb85e.js";const C=b=>(J("data-v-17acca94"),b=b(),Q(),b),sn={class:"app"},an={class:"pageSelection"},cn=["onClick"],tn={class:"blubook"},on=["onClick"],en=["src","onError"],pn={class:"Number"},rn=C(()=>c("span",{style:{display:"none"}},null,-1)),ln={class:"actionDetails"},mn={class:"Number"},Dn=["innerHTML"],yn=["src"],In=["innerHTML"],Ln={class:"Cast100ms"},fn=C(()=>c("span",{style:{color:"#00c2c2"}},"咏唱时间：",-1)),gn={class:"Recast100ms"},hn=C(()=>c("span",{style:{color:"#00c2c2"}},"复唱时间：",-1)),kn=["innerHTML"],Nn=["innerHTML"],An=["innerHTML"],bn=G({__name:"blubook",setup(b){const p=h("blubook-selectIndex",0),i=h("blubook-page",1),D=S(""),v=S(!1),y=h("blubook-notLearnedOnly",!1),u=h("blubook-grayNotLearned",!1),l=h("blubook-learned",{});P(y,()=>{X(()=>{i.value=1})});const e=S([{ID:3,ActionID:11385,Name:"水炮",Number:1,Stats:`攻击类型：魔法
攻击属性：水
...
提示：新出的体型大的那个`},{ID:109,ActionID:34567,Name:"魔法吐息",Number:109,Stats:`攻击类型：魔法
攻击属性：无
...
如果目标的等级高于自身，则无效化。`,AozDescription:"",Icon:"https://cafemaker.wakingsands.com/i/003000/003368_hr1.png",Recast100ms:25,Learn:"伊甸希望乐园 觉醒之章1"},{ID:116,ActionID:34574,Name:"加强信音",Number:116,Stats:`攻击类型：魔法
攻击属性：无
...
<span style='color:#00cc22;'>完美神的祝福时威力：</span>440`,AozDescription:"",Icon:"https://cafemaker.wakingsands.com/i/003000/003369_hr1.png",Learn:"伪造天界格鲁格火山  3号BOSS",Recast100ms:25},{ID:117,ActionID:34575,Name:"力场",Number:117,Stats:`攻击类型：魔法
攻击属性：无
...
对第二个目标及后续目标的威力降低50%。
该行动与<span style='color:#ff7b1a;'>启示录</span>共享冷却时间。`,AozDescription:"",Icon:"https://cafemaker.wakingsands.com/i/003000/003377_hr1.png",Recast100ms:1200,Learn:"缇坦妮雅歼灭战"}]);for(const o of e.value)o.Stats=o.Stats.replaceAll(/(攻击类型|攻击属性|评级)：/g,'<span style="color:#00cc22;">$1：</span>');const z=Y(()=>D.value.trim().length===0?e.value.filter(o=>y.value?!l.value[o.Number.toString()]:!0):e.value.filter(s=>{const t=new RegExp(D.value);return(y.value?!l.value[s.Number.toString()]:!0)&&(t.test(s.Name)||t.test(s.Number.toString())||t.test(s.Description)||t.test(s.Stats)||t.test(s.AozDescription)||t.test(s.Learn))}));function L(o){const s=D.value.trim();if(s){const t=new RegExp(s,"g");o=o.replace(t,r=>`<em>${r}</em>`)}return o}function R(o,s){const t=o.target;/xivapi.com/.test(t.src)||(e.value[s-1].Icon=e.value[s-1].Icon.replace("cafemaker.wakingsands.com","xivapi.com"))}function H(o,s){p.value=s-1}function O(o,s){i.value=s}const $=/^\b(?:\d+(?:-\d+)?(?:,(?=\d)|~\d+)?)+\b$/;function U(o){F.prompt('输入字符串 例如 "1~104"、"1,3,21,24"',"Tip",{confirmButtonText:"确认",cancelButtonText:"取消",inputPattern:$,inputErrorMessage:"格式错误"}).then(({value:s})=>{for(const t of s.split(","))if(/^\d+[\-~]\d+$/.test(t)){const[r,_]=t.split(/[\-~]/).map(Number);for(let f=r;f<=_;f++)l.value[f.toString()]=!0}else l.value[t]=!0}).catch(()=>{K({type:"info",message:"Input canceled"})})}return(o,s)=>{const t=Z,r=j,_=q,f=W;return k(),N("div",sn,[m(t,{modelValue:n(D),"onUpdate:modelValue":s[0]||(s[0]=a=>d(D)?D.value=a:null),placeholder:"搜索技能名称或序号或描述",class:"search"},null,8,["modelValue"]),c("div",an,[(k(!0),N(x,null,B(Math.ceil(n(z).length/16),a=>(k(),N("div",{onClick:I=>O(I,a),class:M(n(i)===a?"selected":"")},A(a),11,cn))),256))]),m(r,{modelValue:n(v),"onUpdate:modelValue":s[1]||(s[1]=a=>d(v)?v.value=a:null),label:"编辑模式",class:"toggleEdingMode",color:"white"},null,8,["modelValue"]),m(r,{modelValue:n(u),"onUpdate:modelValue":s[2]||(s[2]=a=>d(u)?u.value=a:null),label:"没学会的灰度显示",class:"toggleGrayNotLearned",color:"white"},null,8,["modelValue"]),m(r,{modelValue:n(y),"onUpdate:modelValue":s[3]||(s[3]=a=>d(y)?y.value=a:null),label:"只显示没学会的",class:"toggleNotLearnedOnly",color:"white"},null,8,["modelValue"]),m(_,{type:"primary",class:"batchLearning",size:"small",onClick:U},{default:V(()=>[w("批量学习")]),_:1}),c("div",tn,[(k(!0),N(x,null,B(n(z),(a,I)=>(k(),N("div",{key:a.ID,class:"actionGrid"},[m(f,{class:"box-item",effect:"dark",content:a.Name,placement:"top",offset:0,"hide-after":0,"show-arrow":!1,enterable:!1},{default:V(()=>[T(c("div",{class:"grid-item",onClick:g=>H(g,a.Number)},[c("img",{class:M(`IconHD ${!n(l)[a.Number]&&n(u)?"notLearned":"learned"}`),draggable:"false",src:(n(i)-1)*16<=I&&n(i)*16>I?`${a.Icon}`:void 0,onError:g=>R(g,a.Number)},null,42,en),c("div",pn,A(a.Number),1),T(m(r,{modelValue:n(l)[a.Number],"onUpdate:modelValue":g=>n(l)[a.Number]=g,label:a.Number,size:"small",class:"learnedSwitch",color:"white",fill:"#f00"},null,8,["modelValue","onUpdate:modelValue","label"]),[[E,n(v)]])],8,on),[[E,(n(i)-1)*16<=I&&n(i)*16>I]]),rn]),_:2},1032,["content"])]))),128)),c("div",ln,[c("div",mn,A(n(e)[n(p)].Number),1),c("div",{class:"Name",innerHTML:L(n(e)[n(p)].Name)},null,8,Dn),c("img",{class:"IconHD",src:`${n(e)[n(p)].Icon}`,onError:s[4]||(s[4]=a=>R(a,n(p))),draggable:"false"},null,40,yn),c("div",{class:"Stats",innerHTML:L(n(e)[n(p)].Stats)},null,8,In),c("div",Ln,[fn,w(A(n(e)[n(p)].Cast100ms/10),1)]),c("div",gn,[hn,w(A(n(e)[n(p)].Recast100ms/10),1)]),c("div",{class:"Description",innerHTML:L(n(e)[n(p)].Description)},null,8,kn),c("div",{class:"AozDescription",innerHTML:L(n(e)[n(p)].AozDescription)},null,8,Nn),c("div",{class:"Learn",innerHTML:L(n(e)[n(p)].Learn)},null,8,An)])])])}}});const _n=nn(bn,[["__scopeId","data-v-17acca94"]]);export{_n as default};
