...
<a href="#/okVpr2">版本B</a>，进附体时会重置热键栏，适合设置成平时按的键位（我没用过，不知道好不好用）`},{title:"[悬浮窗] 我 TM 现在在几线？",type:"悬浮窗",path:"instancedAreaInfo",comment:"狩猎常用，一个简单的小工具，显示你当前在几线。"},{title:"狩猎车头找怪工具",type:"网页",path:"hunt"},{title:"简易风脉地图",type:"网页",path:"aether"}];return(p,ee)=>{const d=B,f=N,b=l("router-link"),c=l("vxe-column"),g=l("vxe-table"),v=A,w=R,y=k("lazy");return o(),i("div",G,[a(w,{class:"main-container"},{default:t(()=>[a(d,null,{default:t(()=>[Y]),_:1}),a(v,null,{default:t(()=>[a(f,{class:"contact-card"},{header:t(()=>[q]),default:t(()=>[Q]),_:1}),a(g,{data:h,stripe:"",border:"","row-config":{height:120,hover:!0},"scroll-x":{enabled:!0},fit:!0,"auto-resize":!0,class:"custom-table"},{default:t(()=>[a(c,{width:"250",title:"名称","class-name":"column-title"},{default:t(({row:e})=>[e.path.startsWith("http")?(o(),i("a",{key:1,href:e.path,target:"_blank",class:"table-link"},_(e.title),9,X)):(o(),T(b,{key:0,to:e.path,class:"table-link"},{default:t(()=>[C(_(e.title),1)]),_:2},1032,["to"]))]),_:1}),a(c,{width:"400",title:"预览","class-name":"column-title"},{default:t(({row:{src:e}})=>[e?x((o(),i("img",$,null,512)),[[y,u(e).pathname]]):m("",!0),e?m("",!0):(o(),i("i",J,"无"))]),_:1}),a(c,{field:"comment",title:"描述","min-width":"600","class-name":"column-title"},{default:t(({row:e})=>[s("span",{innerHTML:e.comment},null,8,K)]),_:1})]),_:1})]),_:1})]),_:1})])}}});const ae=L(Z,[["__scopeId","data-v-b38ad504"]]);export{ae as default};
