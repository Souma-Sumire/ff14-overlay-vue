...
<a href="#/okVpr2">版本B</a>，进附体时会重置热键栏，适合设置成平时按的键位（我没用过，不知道好不好用）`},{title:"[悬浮窗] 技能监控（不再维护）",type:"悬浮窗",path:"obs",comment:'仅存档，不再维护。替代品：<a href="https://github.com/0ceal0t/JobBars">JobBars</a>'},{title:"国际服汉化补丁",type:"网页",path:"https://github.com/Souma-Sumire/FFXIVChnTextPatch-Souma/",comment:"前往Github项目了解详情"},{title:"个人修改版 Cactbot Raidboss",type:"网页",path:"https://github.com/Souma-Sumire/raidboss-user-js-public",comment:"前往Github项目了解详情"},{title:"简易风脉地图",type:"网页",path:"aether"},{title:"FFLOGS 上传器 加速下载",type:"网页",path:"fflogsUploaderDownload"}];return(c,te)=>{const f=N,b=I,d=R,y=l("router-link"),r=l("vxe-column"),g=l("vxe-table"),w=A,v=D,S=k("lazy");return o(),i("div",J,[s(v,null,{default:t(()=>[s(b,null,{default:t(()=>[s(f,{label:"联系我：","label-width":"auto",style:{"margin-bottom":"0","padding-left":"1rem"}},{default:t(()=>[X]),_:1})]),_:1}),s(d,null,{default:t(()=>[$]),_:1}),s(w,null,{default:t(()=>[s(g,{data:u,stripe:"",border:"","row-config":{height:100}},{default:t(()=>[s(r,{width:"250",title:"名称"},{default:t(({row:e})=>[e.path.startsWith("http")?(o(),i("a",{key:1,href:e.path,target:"_blank"},p(e.title),9,q)):(o(),B(y,{key:0,to:e.path},{default:t(()=>[C(p(e.title),1)]),_:2},1032,["to"]))]),_:1}),s(r,{width:"420",title:"预览"},{default:t(({row:{src:e}})=>[e?x((o(),i("img",K,null,512)),[[S,h(e).pathname]]):_("",!0),e?_("",!0):(o(),i("i",Q,"无"))]),_:1}),s(r,{field:"comment",title:"描述"},{default:t(({row:e})=>[a("span",{innerHTML:e.comment},null,8,Z)]),_:1})]),_:1})]),_:1})]),_:1})])}}});const oe=z(ee,[["__scopeId","data-v-f376797d"]]);export{oe as default};
