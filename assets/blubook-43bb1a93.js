import{d as G,y as h,v as S,a0 as P,aG as X,A as Y,o as k,b as N,a as m,u as n,a3 as d,g as t,G as x,H as B,w as V,f as w,I as A,W as F,X as Q,L as W,az as j,i as q,O as J,P as K,Q as M,D as E,F as T,aC as Z}from"./vendor-8d19117d.js";import{_ as nn}from"./_plugin-vue_export-helper-c27b6911.js";const C=b=>(J("data-v-da8147d8"),b=b(),K(),b),sn={class:"app"},an={class:"pageSelection"},cn=["onClick"],tn={class:"blubook"},on=["onClick"],en=["src","onError"],pn={class:"Number"},rn=C(()=>t("span",{style:{display:"none"}},null,-1)),ln={class:"actionDetails"},mn={class:"Number"},Dn=["innerHTML"],yn=["src"],In=["innerHTML"],Ln={class:"Cast100ms"},fn=C(()=>t("span",{style:{color:"#00c2c2"}},"咏唱时间：",-1)),gn={class:"Recast100ms"},hn=C(()=>t("span",{style:{color:"#00c2c2"}},"复唱时间：",-1)),kn=["innerHTML"],Nn=["innerHTML"],An=["innerHTML"],bn=G({__name:"blubook",setup(b){const p=h("blubook-selectIndex",0),i=h("blubook-page",1),D=S(""),v=S(!1),y=h("blubook-notLearnedOnly",!1),u=h("blubook-grayNotLearned",!1),l=h("blubook-learned",{});P(y,()=>{X(()=>{i.value=1})});const e=S([{ID:3,ActionID:11385,Name:"水炮",Number:1,Stats:`攻击类型：魔法
攻击属性：水
