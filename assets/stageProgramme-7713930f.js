...
`}}z(),w(),Y(()=>{var a;const o=[];[...e.inputRaw.matchAll(/^([ \t\u3000]*(?<time>[:：\d.]+) +)?"?(?<action>.+?)"?(?: *class="(?<className>[^"]+)")?$/gm)].forEach(t=>{var T,M;let s=(T=t.groups)==null?void 0:T.time;if(s!=null&&s.includes(":")){let V=0;s!=null&&s.includes(".")&&(V=Number(s.substr(s.lastIndexOf(".")+1)/10),s=s.substring(0,s.lastIndexOf("."))),s=u.duration(s).as("seconds")/60+V}else s=s?Number(s):null;const E=u.duration(s,"seconds"),P=u({h:E.hours(),m:E.minutes(),s:E.seconds()}).format("mm:ss");o.push({text:t.groups.action,timeSeconds:(s==null?void 0:s.toFixed(1))??null,timeFormat:P,className:((M=t==null?void 0:t.groups)==null?void 0:M.className)??""})}),e.list=o,localStorage.setItem("programmeData",JSON.stringify(e.inputRaw)),localStorage.setItem("programmeStyle",JSON.stringify(e.style));{(a=document.querySelector("#styleHTML"))==null||a.remove();const t=document.createElement("style");t.setAttribute("type","text/css"),t.id="styleHTML",t.innerHTML=e.style.customCSS,document.body.append(t)}});function D(o){return b.test(o)?{fontSize:"18px",justifyContent:"center"}:{}}function R(o){!x.value&&o.detail.inACTCombat&&(_=setInterval(()=>{L()},1e3)),x.value&&!o.detail.inACTCombat&&(clearInterval(_),H()),x.value=o.detail.inACTCombat}function U(){H(),I=setInterval(()=>{L()},100)}function H(){clearInterval(I),x.value=!1,d.value=0,r.value=0,S.value=e.style.lineHeight}function L(){var a;d.value++;for(let t=0;t<e.list.length;t++)if(Number.parseInt(((a=e.list[t].timeSeconds)==null?void 0:a.toString())??"-1")===d.value){S.value=e.style.lineHeight*(t+1),(t>1&&b.test(e.list[t-1].text)||r.value+650-e.style.lineHeight*2.5<e.style.lineHeight*(t+1))&&(r.value=o(e.style.lineHeight*(t-2.5)));break}function o(t){const s=document.querySelector("#main>ul").scrollHeight-650+e.style.lineHeight*1.5;return t>=s&&(t=s),t}}function F(){confirm("确定恢复模板字符串为默认设置吗？")&&(localStorage.removeItem("programmeData"),w())}function J(){confirm("确定恢复自定义CSS为默认设置吗？")&&(localStorage.removeItem("programmeStyle"),w())}return(o,a)=>(f(),C(N,null,[l("div",{id:"warpper",style:m(n(B))},[l("header",null,[lt,l("article",null,v(n($)),1)]),l("main",{id:"main",style:m({overflowY:n(h)?"auto":"hidden"})},[(f(),C("svg",{xmlns:"http://www.w3.org/2000/svg",width:"35",viewBox:"0 0 38 22",fill:"none",class:"icon position",style:m({top:`${n(S)-n(r)}px`,opacity:n(d)})},rt,4)),l("ul",{style:m({transform:`translateY(${-n(r)}px)`})},[(f(!0),C(N,null,q(n(e).list,(t,s)=>(f(),C("li",{key:s,style:m(Object.assign(D(t.text),{height:`${n(e).style.lineHeight}px`})),class:X([b.test(t.text)?"stage":"normal",t.className])},[c(v(t.text)+" ",1),i(l("span",{class:"auxiliary"},v(t.timeFormat),513),[[O,t.timeSeconds&&t.timeSeconds>0&&t.timeFormat]])],6))),128))],4),l("span",{style:m({width:`${n(Z)}px`,top:`${n(e).style.lineHeight+25*1.5-5-n(r)}px`})},v("-".repeat(299)),5)],4)],4),i(l("aside",it,[l("p",null,[l("button",{onClick:a[0]||(a[0]=t=>U())}," 10倍速测试 ")]),l("p",null,[c(" 正文模板 "),l("button",{onClick:a[1]||(a[1]=t=>F())}," 恢复默认正文 ")]),i(l("textarea",{"onUpdate:modelValue":a[2]||(a[2]=t=>n(e).inputRaw=t),cols:"80",rows:"20"},null,512),[[y,n(e).inputRaw]]),l("p",null,[c(" 总缩放"),i(l("input",{"onUpdate:modelValue":a[3]||(a[3]=t=>n(e).style.scale=t),type:"number",step:"0.1",min:"0.5"},null,512),[[y,n(e).style.scale]])]),l("p",null,[c(" 每行高"),i(l("input",{"onUpdate:modelValue":a[4]||(a[4]=t=>n(e).style.lineHeight=t),type:"number",step:"1",min:"20"},null,512),[[y,n(e).style.lineHeight]])]),l("p",null,[c(" 允许用户滚动"),i(l("input",{"onUpdate:modelValue":a[5]||(a[5]=t=>Q(h)?h.value=t:null),type:"checkbox"},null,512),[[K,n(h)]]),c("（该选项不会保存） ")]),l("p",null,[c(" 自定义CSS "),l("button",{onClick:a[6]||(a[6]=t=>J())}," 恢复默认CSS ")]),i(l("textarea",{"onUpdate:modelValue":a[7]||(a[7]=t=>n(e).style.customCSS=t),cols:"80",rows:"30"},null,512),[[y,n(e).style.customCSS]])],512),[[O,n(A)]])],64))}});const ut=st(ct,[["__scopeId","data-v-4bdca458"]]);export{ut as default};
