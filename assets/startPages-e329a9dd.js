import{d as T,r as l,av as k,o,e as i,a as s,w as t,c as C,x as B,y as p,s as x,$ as _,t as a,aj as N,ak as A,D as R,a4 as D,a5 as I,G as W,H as L}from"./vendor-67b87c3f.js";import{_ as M}from"./_plugin-vue_export-helper-c27b6911.js";const z="/ff14-overlay-vue/assets/castingMonitor-6712fc16.webp",O="/ff14-overlay-vue/assets/castingToChinese-3f47f77a.webp",V="/ff14-overlay-vue/assets/dnc-fb351e04.webp",H="/ff14-overlay-vue/assets/keigennRecord2-4142bde2.webp",U="/ff14-overlay-vue/assets/keySkillTimer-794d4a66.webp",j="/ff14-overlay-vue/assets/limitBreakTip-f4c9c6e9.webp",E="/ff14-overlay-vue/assets/raidbuffRecord-3a54552e.webp",F="/ff14-overlay-vue/assets/risingstones-ea75f732.webp",P="/ff14-overlay-vue/assets/teamWatch-b39910c5.webp",G="/ff14-overlay-vue/assets/timeline-6b6992a2.webp",Y="/ff14-overlay-vue/assets/zoneMacro-a2a2a9eb.webp",m=n=>(W("data-v-e194ded7"),n=n(),L(),n),X={class:"common-layout","bt-white":""},$=m(()=>a("div",{style:{display:"flex","align-items":"center",gap:"16px"}},[a("a",{href:"https://github.com/Souma-Sumire",target:"_blank",style:{"text-decoration":"none"}}," Github "),a("a",{href:"https://space.bilibili.com/1443740",target:"_blank",style:{"text-decoration":"none"}}," Bilibili "),a("span",{style:{"font-weight":"bold",color:"#f00"}}," 其余账号均为山寨，请勿相信任何信息 ")],-1)),q=m(()=>a("h1",null,"主页导航",-1)),J=["href"],K={key:0},Q={key:1},Z=["innerHTML"],ee=T({__name:"startPages",setup(n){function h(c){return new URL(Object.assign({"../assets/screenshots/castingMonitor.webp":z,"../assets/screenshots/castingToChinese.webp":O,"../assets/screenshots/dnc.webp":V,"../assets/screenshots/keigennRecord2.webp":H,"../assets/screenshots/keySkillTimer.webp":U,"../assets/screenshots/limitBreakTip.webp":j,"../assets/screenshots/raidbuffRecord.webp":E,"../assets/screenshots/risingstones.webp":F,"../assets/screenshots/teamWatch.webp":P,"../assets/screenshots/timeline.webp":G,"../assets/screenshots/zoneMacro.webp":Y})[`../assets/screenshots/${c}`],self.location)}const u=[{title:"[悬浮窗] 减伤监控2",type:"悬浮窗/网页",path:"keigennRecord2?scale=1&showHeader=true&showIcon=true&showName=false&abbrId=true&anonymous=true&replaceWithYou=false&parseAA=true&parseDoT=false&minimize=false&actionCN=true&statusCN=true",comment:`可以添加到 ACT 悬浮窗中用于实时监控。也可以在浏览器中打开，导入日志分析过往记录。
...
`,src:"keySkillTimer.webp"},{title:"[悬浮窗] 治疗/减伤时间轴",type:"悬浮窗",path:"timeline",src:"timeline.webp",comment:`适用于副职快速抄轴、打小抄等。可以实现简单的阶段同步，但面对血量轴/双轴等复杂情况时表现不佳。

编辑时间轴：启动ACT WSServer，在浏览器中打开<a href="/ff14-overlay-vue/#/timelineSettings?OVERLAY_WS=ws://127.0.0.1:10501/ws">这个链接</a>，数据会自动更新到悬浮窗中，此时切换到悬浮窗应当提示‘已更新数据’。`},{title:"[悬浮窗] 施法监控（技能展示）",type:"悬浮窗",path:"castingMonitor?duration=15&displayAA=false&api=cafemaker&showHeader=true&syncFocusWS=false",src:"castingMonitor.webp",comment:`URL地址栏参数说明：
...
<a href="#/okVpr2">版本B</a>，进附体时会重置热键栏，适合设置成平时按的键位（我没用过，不知道好不好用）`},{title:"[悬浮窗] 技能监控",type:"悬浮窗",path:"https://souma.diemoe.net/dist/teamWatch.html",comment:"可以实现对大部分技能的CD监控。现已进入维护阶段，不再新增特性或修正 BUG。",src:"teamWatch.webp"},{title:"国际服汉化补丁",type:"网页",path:"https://github.com/Souma-Sumire/FFXIVChnTextPatch-Souma/",comment:"前往Github项目了解详情"},{title:"个人修改版 Cactbot Raidboss",type:"网页",path:"https://github.com/Souma-Sumire/raidboss-user-js-public",comment:"前往Github项目了解详情"},{title:"简易风脉地图",type:"网页",path:"aether"},{title:"FFLOGS 上传器 加速下载",type:"网页",path:"fflogsUploaderDownload"}];return(c,te)=>{const f=N,d=A,b=R,y=l("router-link"),r=l("vxe-column"),g=l("vxe-table"),w=D,v=I,S=k("lazy");return o(),i("div",X,[s(v,null,{default:t(()=>[s(d,null,{default:t(()=>[s(f,{label:"联系我：","label-width":"auto",style:{"margin-bottom":"0","padding-left":"1rem"}},{default:t(()=>[$]),_:1})]),_:1}),s(b,null,{default:t(()=>[q]),_:1}),s(w,null,{default:t(()=>[s(g,{data:u,stripe:"",border:"","row-config":{height:100}},{default:t(()=>[s(r,{width:"250",title:"名称"},{default:t(({row:e})=>[e.path.startsWith("http")?(o(),i("a",{key:1,href:e.path,target:"_blank"},p(e.title),9,J)):(o(),C(y,{key:0,to:e.path},{default:t(()=>[B(p(e.title),1)]),_:2},1032,["to"]))]),_:1}),s(r,{width:"420",title:"预览"},{default:t(({row:{src:e}})=>[e?x((o(),i("img",K,null,512)),[[S,h(e).pathname]]):_("",!0),e?_("",!0):(o(),i("i",Q,"无"))]),_:1}),s(r,{field:"comment",title:"描述"},{default:t(({row:e})=>[a("span",{innerHTML:e.comment},null,8,Z)]),_:1})]),_:1})]),_:1})]),_:1})])}}});const oe=M(ee,[["__scopeId","data-v-e194ded7"]]);export{oe as default};
