import{d as $,b as g,r as _,Q as X,al as P,c as Y,f as k,g as N,k as l,i as n,T as u,h as c,F as R,m as x,l as B,j as S,t as m,bX as F,E as G,q as j,s as q,x as V,w as E,v as M,at as Q}from"./index.js";import{E as J}from"./el-input.js";import{E as K,a as W}from"./index2.js";import{_ as Z}from"./_plugin-vue_export-helper.js";import"./index3.js";import"./scroll.js";import"./vnode.js";const w=A=>(j("data-v-458db7ef"),A=A(),q(),A),nn={class:"app"},sn={class:"pageSelection"},an=["onClick"],cn={class:"blubook"},tn=["onClick"],on=["src","onError"],en={class:"Number"},pn=w(()=>c("span",{style:{display:"none"}},null,-1)),rn={class:"actionDetails"},ln={class:"Number"},mn={class:"Name"},Dn=["src"],yn=["innerHTML"],In={class:"Cast100ms"},Ln=w(()=>c("span",{style:{color:"#00c2c2"}},"咏唱时间：",-1)),fn={class:"Recast100ms"},hn=w(()=>c("span",{style:{color:"#00c2c2"}},"复唱时间：",-1)),gn=["innerHTML"],kn=["innerHTML"],Nn={class:"Learn"},An=$({__name:"blubook",setup(A){const e=g("blubook-selectIndex",0),r=g("blubook-page",1),L=_(""),b=_(!1),D=g("blubook-notLearnedOnly",!1),v=g("blubook-grayNotLearned",!1),i=g("blubook-learned",{});X(D,()=>{P(()=>{r.value=1})});const t=_([{ID:3,ActionID:11385,Name:"水炮",Number:1,Stats:`攻击类型：魔法
攻击属性：水
