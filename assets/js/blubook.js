import{d as $,b as g,r as _,Q as X,al as P,c as Y,f as k,g as N,k as l,i as n,T as u,h as c,F as R,m as x,l as B,j as S,t as m,bX as F,E as G,q as j,s as q,x as V,w as E,v as M,at as Q}from"./index.js";import{E as J}from"./el-input.js";import{E as K,a as W}from"./index2.js";import{_ as Z}from"./_plugin-vue_export-helper.js";import"./index3.js";import"./scroll.js";import"./vnode.js";const w=A=>(j("data-v-3c3b73ec"),A=A(),q(),A),nn={class:"app"},sn={class:"pageSelection"},an=["onClick"],cn={class:"blubook"},tn=["onClick"],on=["src","onError"],en={class:"Number"},pn=w(()=>c("span",{style:{display:"none"}},null,-1)),rn={class:"actionDetails"},ln={class:"Number"},mn={class:"Name"},Dn=["src"],yn=["innerHTML"],In={class:"Cast100ms"},Ln=w(()=>c("span",{style:{color:"#00c2c2"}},"咏唱时间：",-1)),fn={class:"Recast100ms"},hn=w(()=>c("span",{style:{color:"#00c2c2"}},"复唱时间：",-1)),gn=["innerHTML"],kn=["innerHTML"],Nn={class:"Learn"},An=$({__name:"blubook",setup(A){const e=g("blubook-selectIndex",0),r=g("blubook-page",1),L=_(""),b=_(!1),D=g("blubook-notLearnedOnly",!1),v=g("blubook-grayNotLearned",!1),i=g("blubook-learned",{});X(D,()=>{P(()=>{r.value=1})});const t=_([{ID:3,ActionID:11385,Name:"水炮",Number:1,Stats:`攻击类型：魔法
攻击属性：水
...
对第二个目标及后续目标的威力降低50%。
该行动与<span style='color:#ff7b1a;'>启示录</span>共享冷却时间。`,AozDescription:"",Icon:"https://cafemaker.wakingsands.com/i/003000/003377_hr1.png",Recast100ms:1200,Learn:"缇坦妮雅歼灭战"}]);for(const o of t.value)o.Stats=o.Stats.replaceAll(/(攻击类型|攻击属性|评级)：/g,'<span style="color:#00cc22;">$1：</span>'),o.Number>=105&&(o.Icon=o.Icon.replace("cafemaker.wakingsands.com","xivapi.com"));const C=Y(()=>L.value.length===0?t.value.filter(o=>D.value?!i.value[o.Number.toString()]:!0):t.value.filter(s=>{const p=new RegExp(L.value);return(D.value?!i.value[s.Number.toString()]:!0)&&(p.test(s.Name)||p.test(s.Number.toString())||p.test(s.Description))}));function z(o,s){const p=o.target;/xivapi.com/.test(p.src)||(t.value[s-1].Icon=t.value[s-1].Icon.replace("cafemaker.wakingsands.com","xivapi.com"))}function O(o,s){e.value=s-1}function T(o,s){r.value=s}const H=/^\b(?:\d+(?:-\d+)?(?:,(?=\d)|~\d+)?)+\b$/;function U(o){K.prompt('输入字符串 例如 "1~104"、"1,3,21,24"',"Tip",{confirmButtonText:"确认",cancelButtonText:"取消",inputPattern:H,inputErrorMessage:"格式错误"}).then(({value:s})=>{for(const p of s.split(","))if(/^\d+[\-~]\d+$/.test(p)){const[y,d]=p.split(/[\-~]/).map(Number);for(let f=y;f<=d;f++)i.value[f.toString()]=!0}else i.value[p]=!0}).catch(()=>{W({type:"info",message:"Input canceled"})})}return(o,s)=>{const p=J,y=F,d=G,f=Q;return k(),N("div",nn,[l(p,{modelValue:n(L),"onUpdate:modelValue":s[0]||(s[0]=a=>u(L)?L.value=a:null),placeholder:"搜索技能名称或序号或描述",class:"search"},null,8,["modelValue"]),c("div",sn,[(k(!0),N(R,null,x(Math.ceil(n(C).length/16),a=>(k(),N("div",{onClick:I=>T(I,a),class:V(n(r)===a?"selected":"")},m(a),11,an))),256))]),l(y,{modelValue:n(b),"onUpdate:modelValue":s[1]||(s[1]=a=>u(b)?b.value=a:null),label:"编辑模式",class:"toggleEdingMode",color:"white"},null,8,["modelValue"]),l(y,{modelValue:n(v),"onUpdate:modelValue":s[2]||(s[2]=a=>u(v)?v.value=a:null),label:"没学会的灰度显示",class:"toggleGrayNotLearned",color:"white"},null,8,["modelValue"]),l(y,{modelValue:n(D),"onUpdate:modelValue":s[3]||(s[3]=a=>u(D)?D.value=a:null),label:"只显示没学会的",class:"toggleNotLearnedOnly",color:"white"},null,8,["modelValue"]),l(d,{type:"primary",class:"batchLearning",size:"small",onClick:U},{default:B(()=>[S("批量学习")]),_:1}),c("div",cn,[(k(!0),N(R,null,x(n(C),(a,I)=>(k(),N("div",{key:a.ID,class:"actionGrid"},[l(f,{class:"box-item",effect:"dark",content:a.Name,placement:"top",offset:0,"hide-after":0,"show-arrow":!1,enterable:!1},{default:B(()=>[E(c("div",{class:"grid-item",onClick:h=>O(h,a.Number)},[c("img",{class:V(`IconHD ${!n(i)[a.Number]&&n(v)?"notLearned":"learned"}`),src:(n(r)-1)*16<=I&&n(r)*16>I?`${a.Icon}`:void 0,onError:h=>z(h,a.Number)},null,42,on),c("div",en,m(a.Number),1),E(l(y,{modelValue:n(i)[a.Number],"onUpdate:modelValue":h=>n(i)[a.Number]=h,label:a.Number,size:"small",class:"learnedSwitch",color:"white",fill:"#f00"},null,8,["modelValue","onUpdate:modelValue","label"]),[[M,n(b)]])],8,tn),[[M,(n(r)-1)*16<=I&&n(r)*16>I]]),pn]),_:2},1032,["content"])]))),128)),c("div",rn,[c("div",ln,m(n(t)[n(e)].Number),1),c("div",mn,m(n(t)[n(e)].Name),1),c("img",{class:"IconHD",src:`${n(t)[n(e)].Icon}`,onError:s[4]||(s[4]=a=>z(a,n(e)))},null,40,Dn),c("div",{class:"Stats",innerHTML:n(t)[n(e)].Stats},null,8,yn),c("div",In,[Ln,S(m(n(t)[n(e)].Cast100ms/10),1)]),c("div",fn,[hn,S(m(n(t)[n(e)].Recast100ms/10),1)]),c("div",{class:"Description",innerHTML:n(t)[n(e)].Description},null,8,gn),c("div",{class:"AozDescription",innerHTML:n(t)[n(e)].AozDescription},null,8,kn),c("div",Nn,m(n(t)[n(e)].Learn),1)])])])}}});const zn=Z(An,[["__scopeId","data-v-3c3b73ec"]]);export{zn as default};
