import{d as X,b as h,r as S,Q as P,al as Y,c as F,f as k,g as N,k as m,i as n,T as d,h as t,F as x,m as B,l as E,j as w,t as A,bX as G,E as j,q,s as Q,x as V,w as M,v as T,at as J}from"./index.js";import{E as K}from"./el-input.js";import{E as W,a as Z}from"./index2.js";import{_ as nn}from"./_plugin-vue_export-helper.js";import"./index3.js";import"./scroll.js";import"./vnode.js";const C=b=>(q("data-v-da8147d8"),b=b(),Q(),b),sn={class:"app"},an={class:"pageSelection"},cn=["onClick"],tn={class:"blubook"},on=["onClick"],en=["src","onError"],pn={class:"Number"},rn=C(()=>t("span",{style:{display:"none"}},null,-1)),ln={class:"actionDetails"},mn={class:"Number"},Dn=["innerHTML"],yn=["src"],In=["innerHTML"],Ln={class:"Cast100ms"},fn=C(()=>t("span",{style:{color:"#00c2c2"}},"咏唱时间：",-1)),gn={class:"Recast100ms"},hn=C(()=>t("span",{style:{color:"#00c2c2"}},"复唱时间：",-1)),kn=["innerHTML"],Nn=["innerHTML"],An=["innerHTML"],bn=X({__name:"blubook",setup(b){const p=h("blubook-selectIndex",0),i=h("blubook-page",1),D=S(""),v=S(!1),y=h("blubook-notLearnedOnly",!1),u=h("blubook-grayNotLearned",!1),l=h("blubook-learned",{});P(y,()=>{Y(()=>{i.value=1})});const e=S([{ID:3,ActionID:11385,Name:"水炮",Number:1,Stats:`攻击类型：魔法
攻击属性：水
