import{d as U,b as k,r as L,Q as $,al as P,c as X,f as N,g as A,k as l,i as n,T as S,h as c,F as v,m as x,l as B,j as w,t as m,bX as Y,E as G,q as j,s as q,x as O,w as E,v as T,at as Q}from"./index.js";import{E as J}from"./el-input.js";import{E as K,a as W}from"./index2.js";import{_ as Z}from"./_plugin-vue_export-helper.js";import"./index3.js";import"./scroll.js";import"./vnode.js";const C=b=>(j("data-v-4f146a08"),b=b(),q(),b),nn={class:"app"},sn={class:"pageSelection"},an=["onClick"],cn={class:"blubook"},tn=["onClick"],on=["src","onError"],en={class:"Number"},pn=C(()=>c("span",{style:{display:"none"}},null,-1)),rn={class:"actionDetails"},ln={class:"Number"},mn={class:"Name"},Dn=["src"],yn=["innerHTML"],In={class:"Cast100ms"},fn=C(()=>c("span",{style:{color:"#00c2c2"}},"咏唱时间：",-1)),gn={class:"Recast100ms"},hn=C(()=>c("span",{style:{color:"#00c2c2"}},"复唱时间：",-1)),kn=["innerHTML"],Nn=["innerHTML"],An={class:"Learn"},bn=U({__name:"blubook",setup(b){const e=k("blubook-selectIndex",0),r=k("blubook-page",1),f=L(""),u=L(!1),D=k("blubook-notLearnedOnly",!1),d=k("blubook-grayNotLearned",!1),i=k("blubook-learned",{});$(D,()=>{P(()=>{r.value=1})});const t=L([{ID:3,ActionID:11385,Name:"水炮",Number:1,Stats:`攻击类型：魔法
攻击属性：水
...
该魔法有单独计算的复唱时间。`,AozDescription:"",Icon:"https://cafemaker.wakingsands.com/i/003000/003370_hr1.png",Learn:"萨菲洛特歼灭战/图腾兑换",Recast100ms:1200},{ID:118,ActionID:34576,Name:"断罪飞翔",Number:118,Stats:`攻击类型：物理・突
攻击属性：无
