...
const menu: Menu[] = [
  { title: "🌱【新】（ACT悬浮窗）施法监控", type: "悬浮窗", path: "castingMonitor?duration=25&energySaving=true&displayAA=false&displayGCDSpace=false&api=cafemaker&syncFocusWS=true&showHeader=true" },
  ...
  { title: "🤷（ACT悬浮窗）我TM现在在几线？", type: "悬浮窗", path: "instancedAreaInfo" },
  { title: "📖（ACT悬浮窗）绝龙诗双分摊修血记录", type: "悬浮窗", path: "dsrP6" },
