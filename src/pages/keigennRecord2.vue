      ...
      >
        ...
        >
          <template #default="{ row }">
            <KeigennRecord2Target :row="row"></KeigennRecord2Target>
          </template>
        </vxe-column>
        <vxe-column :width="size.amount" title="伤害" header-align="center">
          <template #default="{ row }">
            <KeigennRecord2Amount :row="row"></KeigennRecord2Amount>
          </template>
        </vxe-column>
        <vxe-column title="减伤" align="left">
          <template #default="{ row }">
            <KeigennRecord2StatusShow :row="row"></KeigennRecord2StatusShow>
          </template>
        </vxe-column>
      </vxe-table>
    </main>
