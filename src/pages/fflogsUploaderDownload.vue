...
import { ElContainer, ElLink, ElMain } from "element-plus";
...
const accelerationNodeList = [
  ...
  [
    "https://github.yongyong.online/https://github.com",
    "美国",
    "[美国 Cloudflare CDN] - 该公益加速源由 [github.yongyong.online] 提供",
  ],
  [
  ...
  [
    ...
    "美国",
    "[美国 Cloudflare CDN] - 该公益加速源由 [FastGit 群组成员] 提供",
  ],
  [
  ...
  [
    ...
    "美国",
    "[美国 Cloudflare CDN] - 该公益加速源由 [github.geekery.cn] 提供",
  ],
  [
  ...
  [
    "https://gh.cache.cloudns.org/https://github.com",
    "美国",
    "[美国 Cloudflare CDN] - 该公益加速源由 [gh.cache.cloudns.org] 提供",
  ],
  [
  ...
  [
    ...
    "美国",
    "[美国 Cloudflare CDN] - 该公益加速源由 [gh.llkk.cc] 提供",
  ],
  [
  ...
  [
    ...
    "英国",
    "[英国伦敦] - 该公益加速源由 [ghproxy.net] 提供",
  ],
  [
    "https://ghfast.top/https://github.com",
    "其他",
    "[日本、韩国、新加坡、美国、德国等]（CDN 不固定） - 该公益加速源由 [ghproxy.link] 提供",
  ],
  [
  ...
  [
    "https://kkgithub.com",
    "其他",
    "[中国香港、日本、韩国、新加坡等] - 该公益加速源由 [help.kkgithub.com] 提供",
  ],
];
onMounted(() => {
  fetch("https://api.github.com/repos/RPGLogs/Uploaders-fflogs/releases/latest", { method: "GET" })
    ...
    .then((res) => {
      fileName.value = res.assets.find((v: { name: string }) => /v.+\.exe$/.test(v.name)).name;
      data.res = res;
    })
    .catch((err) => {
      if (err.status === 403) showErrorPopup("您的网络环境不允许访问GitHub API，请检查网络设置。");
      else showErrorPopup(err);
    });
});
