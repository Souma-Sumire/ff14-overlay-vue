...
const config = useStorage('okVpr2Settings', {
  lang: 'cn' as Lang,
  hotbar: {
    standard: [2, 1],
    technical: [2, 2],
...
onMounted(() => {
  ...
  addOverlayListener('LogLine', (e) => {
    if (netRegex.gainsEffect.test(e.rawLine)) {
      ...
      else if (Object.values(effects).includes(e.line[2])) {
...
<template>
  <div bg-white p-l-3>
    <el-form label-width="9rem" style="max-width: 300px">
      ...
      <el-form-item label="自动切换热键栏">
        <el-switch v-model="config.postnamazu" active-color="#13ce66" inactive-color="#ff4949" />
      </el-form-item>
      <el-form-item label="TTS提示">
        <el-switch v-model="config.tts" active-color="#13ce66" inactive-color="#ff4949" />
      </el-form-item>
    </el-form>
