...
windowAction.set(25533, [60, 60]); //绝龙诗 万物终结
windowAction.set(26376, [999, 999]); //绝龙诗 灭绝之诗
windowAction.set(26814, [999, 999]); //绝龙诗 邪龙爪牙
windowAction.set(25313, [200, 200]); //绝龙诗 空间牢狱
windowAction.set(27526, [1000, 30]); //绝龙诗 圣徒化
windowAction.set(26215, [500, 30]); //绝龙诗 P6: Nidhogg v2
windowAction.set(29050, [200, 30]); //绝龙诗 P6.5: Eyes v2
...
windowAction.set(25544, [300, 20]); //绝龙诗 阿斯卡隆之仁·隐秘
