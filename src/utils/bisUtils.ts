...
export function isBisItem(row: BisRow, playerBis: Record<string, BisValue>): boolean {
...
export function countObtainedItems(row: BisRow, obtainedItems: Record<string, number>): number {
