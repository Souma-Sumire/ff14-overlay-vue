...
const skillChinese: KeySkill[] = [
  ...
  { key: crypto.randomUUID(), id: 7405, tts: '行吟', duration: 15, recast1000ms: 90, job: [23], line: 2, minLevel: 62 },
  { key: crypto.randomUUID(), id: 16889, tts: '策动', duration: 15, recast1000ms: 90, job: [31], line: 2, minLevel: 56 },
  { key: crypto.randomUUID(), id: 2887, tts: '武解', duration: 10, recast1000ms: 120, job: [31], line: 2, minLevel: 62 },
  { key: crypto.randomUUID(), id: 16012, tts: '桑巴', duration: 15, recast1000ms: 90, job: [38], line: 2, minLevel: 56 },
