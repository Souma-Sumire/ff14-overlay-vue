...
export const defaultMacro: { zoneId: ZoneIdInfo } = {
  ...
  `),
      },
      {
        ...
        Type: "place",
        Place: {
          A: { X: 100.0, Y: 0.0, Z: 81.2, ID: 0, Active: true },
          B: { X: 108.8, Y: 0.0, Z: 91.2, ID: 3, Active: true },
          C: { X: 100.0, Y: 0.0, Z: 118.8, ID: 2, Active: true },
          D: { X: 91.2, Y: 0.0, Z: 108.8, ID: 1, Active: true },
          One: { X: 98.8, Y: 0.0, Z: 98.8, ID: 4, Active: true },
          Two: { X: 101.2, Y: 0.0, Z: 98.8, ID: 5, Active: true },
          Three: { X: 92.4, Y: 0.0, Z: 92.4, ID: 6, Active: true },
          Four: { X: 107.6, Y: 0.0, Z: 107.6, ID: 7, Active: true },
        },
      },
      {
