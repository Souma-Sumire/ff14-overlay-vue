...
const PT: Data = {
  ...
  enemiesData: {
    ...
    14208: { detect: 'visual', grade: 'caution', note: '巡逻怪\n读条三重/四重强击，攻击对应次数后以当前面向释放秒杀级扇形。', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: false, slow: undefined } }, // 召引洪巴巴 invoked Humbaba インヴォークド・フンババ
    ...
    14215: { detect: 'visual', grade: 'danger', note: '闪电：读条前方圆形AOE。\n地狱爪击：读条前方扇形AOE。\n摆尾：不可见的大范围后方扇形AOE。\n雷光：不可见的点某人脚下的黄圈', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: true, slow: undefined } }, // 召引刻耳柏洛斯 invoked Cerberus インヴォークド・ケルベロス
