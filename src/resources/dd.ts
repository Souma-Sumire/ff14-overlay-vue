...
const PT: Data = {
  ...
  enemiesData: {
    ...
    14266: { detect: 'scope', grade: 'caution', note: '深层版本，几乎全抗性\n尽快击杀，打断怨念', vulnerabilities: { slow: undefined, sleep: false, heavy: undefined, stun: false, bind: undefined } }, // 拟态怪 mimic ミミック
    ...
    14102: { detect: 'visual', grade: 'easy', note: '读条脚底黄圈', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: true, slow: undefined } }, // 交错路普卡精 traverse phooka トラバース・プーカ
    ...
    14151: { detect: 'visual', grade: 'caution', note: '飞驰：强力击退，可以隔墙躲避。\n天马嘶啸：延迟中范围钢铁，可以隔墙躲避。', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: true, slow: undefined } }, // 交错路天马 traverse pegasus トラバース・ペガサス
    ...
    14186: { detect: 'visual', grade: 'danger', note: '延迟前方扇形石化（无法背对躲避！）吃到基本就死了。\n延迟小范围钢铁。', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: true, slow: undefined } }, // 得到宽恕的贪食 forgiven voracity フォーギヴン・ヴォラシティ
    ...
    // 71-80层
    14191: { detect: 'visual', grade: 'caution', note: '读条钢铁 或 正面超大扇形，可以隔墙躲避。', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: true, slow: undefined } }, // 得到宽恕的争执 forgiven dissention フォーギヴン・ディセンション
    ...
    14195: { detect: 'visual', grade: 'danger', note: '巡逻怪\n读条钢铁，死了会自爆！！！！！！', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: false, slow: undefined } }, // 交错路爆岩怪 traverse huldu トラバース・フルドゥ
    14196: { detect: 'visual', grade: 'easy', note: '点名脚底黄圈', vulnerabilities: { sleep: true, bind: undefined, heavy: undefined, stun: true, slow: undefined } }, // 交错路泡沫奶黄怪 traverse diplomat cream トラバース・ホイップカスタード
    ...
    14214: { detect: 'visual', grade: 'easy', note: '大凶眼：很大范围的背对\n眼光弹：点名脚底黄圈', vulnerabilities: { bind: undefined, heavy: undefined, sleep: undefined, stun: true, slow: undefined } }, // 召引盖因 invoked caym インヴォークド・カイム
