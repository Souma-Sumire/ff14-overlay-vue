...
const data: ZoneInfoType = {
  ...
  1116: {
    ...
    name: {
      cn: "水晶冲突（机关大殿）",
      de: "Crystalline Conflict: Die Mechanische Menagerie",
      en: "Crystalline Conflict (The Clockwork Castletown)",
      fr: "Crystalline Conflict (Le Traquenard oriental)",
      ja: "クリスタルコンフリクト(東方絡繰御殿)",
    },
    offsetX: 0,
    offsetY: 0,
    sizeFactor: 400,
