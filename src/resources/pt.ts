...
const PtEnemies: EnemyDataRecord = {
  ...
  13979: { detect: '视觉', grade: '小心', note: '小怪会复制BOSS的技能，可选中后尽快击杀。\nBOSS还会释放捕食，记好预兆寻找安全区。' }, // '花人' 10层BOSS
  ...
  // 31-40层
  13977: { detect: '视觉', grade: '简单', note: '小怪会复读技能：黄色为钢铁 蓝色为击退。\n小怪可选中后尽快击杀。' }, // '得到宽恕的纯真' 40层BOSS
  ...
  14263: { detect: '视觉', grade: '简单', note: '不可以长时间站在流沙中。\n龙卷风需要在倒计时结束时站在流沙里避免被击退。' }, // '奥古布纳巴里' 50层BOSS

  // 51-60层
  14097: { detect: '视觉', grade: '小心', note: '小仙人掌对自身所在格造成伤害。\n大仙人掌对自身及周围9格造成伤害' }, // '元祖马利克刺人仙' 60层BOSS
