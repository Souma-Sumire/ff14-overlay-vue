...
windowAction.set(0x4830, {
  type: 'cast',
  window: [200, 60],
  syncOnce: true,
  battleOnce: true,
}) // 鹰式破坏炮
windowAction.set(0x4854, {
  type: 'cast',
  window: [250, 65],
  syncOnce: true,
  battleOnce: true,
}) // 正义飞踢
windowAction.set(0x485a, {
  type: 'begincast',
  window: [500, 500],
  syncOnce: true,
  battleOnce: true,
}) // 时间停止
windowAction.set(0x4878, {
  type: 'begincast',
  window: [67, 67],
  syncOnce: true,
}) // 神圣审判
windowAction.set(0x4879, { type: 'cast', window: [67, 67], syncOnce: true }) // 神圣审判
windowAction.set(0x4a8b, {
  type: 'cast',
  window: [900, 200],
  syncOnce: true,
  battleOnce: true,
...
// 绝伊甸
windowAction.set(0x9cff, {
  type: 'begincast',
  window: [200, 20],
  syncOnce: true,
}) // P2 四重强击
windowAction.set(0x9d49, {
  type: 'begincast',
  window: [500, 20],
  syncOnce: true,
  battleOnce: true,
}) // P3 地狱审判
windowAction.set(0x9d36, {
  type: 'begincast',
  window: [999, 30],
  syncOnce: true,
  battleOnce: true,
}) // P4 具象化
windowAction.set(0x9d72, {
  type: 'begincast',
  window: [30, 30],
  syncOnce: true,
}) // P5 光尘之剑
...
// 绝神兵未实测
windowAction.set(0x2b5f, {
  type: 'begincast',
  window: [310, 30],
  syncOnce: true,
  battleOnce: true,
}) // P2 深红旋风
windowAction.set(0x2cfd, {
  type: 'begincast',
  window: [600, 30],
  syncOnce: true,
  battleOnce: true,
}) // P3 大地粉碎
windowAction.set(0x2b72, {
  type: 'begincast',
  window: [100, 30],
  syncOnce: true,
  battleOnce: true,
}) // P4 雾散爆发
windowAction.set(0x2b87, {
  type: 'begincast',
  window: [60, 60],
  syncOnce: true,
}) // 魔导核爆
windowAction.set(0x2b76, {
  type: 'begincast',
  window: [100, 100],
  syncOnce: true,
  battleOnce: true,
}) // 追击之究极幻想
windowAction.set(0x2d4c, {
  type: 'begincast',
  window: [100, 100],
  syncOnce: true,
  battleOnce: true,
}) // 爆击之究极幻想
windowAction.set(0x2d4d, {
  type: 'begincast',
  window: [100, 100],
  syncOnce: true,
  battleOnce: true,
...
// M5S
windowAction.set(0xa721, {
  type: 'begincast',
  window: [9.6, 2],
  syncOnce: true,
}) // 经典铭心
windowAction.set(0xa756, {
  type: 'cast',
  window: [77.2, 30],
  syncOnce: true,
  battleOnce: true,
...
// M8S
windowAction.set(0xa3da, {
  type: 'begincast',
  window: [10, 10],
  syncOnce: false,
}) // 空间斩
windowAction.set(0xa3d0, {
  type: 'begincast',
  window: [20, 30],
  syncOnce: true,
}) // 风之狼吼
windowAction.set(0xa3d3, {
  type: 'begincast',
  window: [20, 20],
  syncOnce: true,
}) // 土之狼吼
windowAction.set(0xa749, {
  type: 'begincast',
  window: [60, 60],
  syncOnce: true,
  battleOnce: true,
}) // 风尘光狼斩
windowAction.set(0xa3f1, {
  type: 'begincast',
  window: [20, 20],
  syncOnce: true,
}) // 空间灭斩
windowAction.set(0xa38f, {
  type: 'cast',
  window: [60, 60],
  syncOnce: true,
  battleOnce: true,
}) // --middle--
windowAction.set(0xa82d, {
  type: 'cast',
  window: [60, 60],
  syncOnce: true,
  battleOnce: true,
